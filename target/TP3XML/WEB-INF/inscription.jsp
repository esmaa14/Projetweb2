...
<body> 
    ...
    <div class="formulaire">
 	<form action="add.jsp" method="post" name="cv_add"  id='cv_add' >
	...
	<fieldset>
		...
		<p><label for="text"> Adresse <span class="title">*</span></label>
 		 <textarea  name="adresse" id="adresse" placeholder="Inserer votre Adresse"  ></textarea>
	        ...
	        <p><label for="tel">Tél <span class="title">*</span></label>
		<input type="text" id="tel" name="tel" placeholder="03364775236" required></p>
		
		 
	
	        <p>
				<h4><img id="overview_exp" name="overview_exp" src="./images/plus.gif"
				...
				<p>				
						<div class="formulaire">
							<fieldset>
								...
								<p>
									<label for="text"> Déscription  </label>
							...
							<img id="exp2" name="exp2" src="./images/add.gif"
							...
							<fieldset>
								...
								<p>
								 ...
								 <img id="exp3" name="exp3" src="./images/add.gif" style="display:none;"
								...
								<p>
									...
									<textarea  name="description3" id="description3" placeholder="Inserer une Description"  ></textarea>
										...
										<img id="exp4" name="exp4" src="./images/add.gif" style="display:none;"
